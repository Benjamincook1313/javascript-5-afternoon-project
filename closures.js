...
/*
  ...
  The second function is called dec, this function is responsible for decrementing the value by 
  one and returning the updated value.
...
/*
  ...
  number. takeAwayFromSecret should have a parameter that takes away from the secret number returning the 
...
/*
  ...
  However, because each call to console.log occurs after the loop has finished, the value of i 
  has changed before the console.log executes.
